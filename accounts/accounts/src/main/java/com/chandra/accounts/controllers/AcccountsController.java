package com.chandra.accounts.controllers;

import com.chandra.accounts.constants.AccountsConstants;
import com.chandra.accounts.dto.CustomerDto;
import com.chandra.accounts.dto.ErrorResponseDto;
import com.chandra.accounts.dto.ResponseDto;
...
@Tag(
        ...
        description = "CURD REST APIs in EasyBank to CREATE, FETCH, UPDATE and DELETE Accounts details"
)
@RestController
@RequestMapping(path = "/api", produces = {MediaType.APPLICATION_JSON_VALUE})
@AllArgsConstructor
@Validated
public class AcccountsController {
    ...
    public ResponseEntity<ResponseDto> updateAccountDetails(@Valid @RequestBody CustomerDto customerDto) {
        ...
        if (isUpdated) {
            ...
            return ResponseEntity
                    ...
                    .body(new ResponseDto(AccountsConstants.SATUS_417, AccountsConstants.MESSAGE_417_UPDATE));
        }
    }
    ...
    public ResponseEntity<ResponseDto> deleteAccountDetails(
        ...
        if (isDeleted) {
            ...
            return ResponseEntity
                    .status(HttpStatus.EXPECTATION_FAILED)
                    .body(new ResponseDto(AccountsConstants.SATUS_417, AccountsConstants.MESSAGE_417_DELETE));
        }
    }
